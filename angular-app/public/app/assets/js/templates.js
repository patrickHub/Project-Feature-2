angular.module('github-explorer').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/modules/feature1/feature1.html',
  ...
  $templateCache.put('app/modules/feature2/feature2.html',
    "<div class=\"md-padding\" flex layout-sm=\"column\">\n" +
    "   <!--\n" +
    "    <md-card>\n" +
    "        <md-card-content> -->\n" +
    "            <h2 class=\"md-title\">You can see a nice graph</h2>\n" +
  ...
  $templateCache.put('app/modules/feature3/feature3.html',
    "<div class=\"md-padding\" flex layout-sm=\"column\">\n" +
    "    <md-card>\n" +
    "        <md-card-content>\n" +
    "            <h2 class=\"md-title\">Content from: feature3 page</h2>\n" +
    "        </md-card-content>\n" +
    "    </md-card>\n" +
    "</div>\n"
  );
